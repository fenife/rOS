 ...
 * 最后的((packed))用于告诉编译器，不允许为对齐而在此结构中
 * 填充空隙，从而保证此结构是16字节大小 
 */
 ...
 */
static bool partition_info(struct node * pelem, int arg UNUSED)
{
